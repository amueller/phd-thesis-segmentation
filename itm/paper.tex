...
\begin{itemize}
    \item Clustering, as a purely unsupervised methods is on one end of the spectrum of algorithms we investigate.
        ...
        expecation of what semisupervised and supervised algorithms have at least to achieve.
...
an imortant building block for the methods in this work.
%
...
Another draw-back is the non-determinism of the procedure, caused by the
dependence on random initialization.
...
\begin{figure}
\centering
\includegraphics[width=.3\textwidth]{illustration_left}
\includegraphics[width=.3\textwidth]{illustration_center}
\includegraphics[width=.3\textwidth]{illustration_right}
...
We use the dual-tree Boruvka algorithm~\citep{dtb2010} to compute the minimum
...
\begin{figure}[t]
\centering
\includegraphics[width=.2\textwidth]{qualitative_blobs_km}
\includegraphics[width=.2\textwidth]{qualitative_blobs_mean_nn}
\includegraphics[width=.2\textwidth]{qualitative_blobs_aggl}
\includegraphics[width=.2\textwidth]{qualitative_blobs_mst} \\ 

\includegraphics[width=.2\textwidth]{qualitative_circles_km}
\includegraphics[width=.2\textwidth]{qualitative_circles_mean_nn}
\includegraphics[width=.2\textwidth]{qualitative_circles_aggl}
\includegraphics[width=.2\textwidth]{qualitative_circles_mst} \\ 

\includegraphics[width=.2\textwidth]{qualitative_circles2_km}
\includegraphics[width=.2\textwidth]{qualitative_circles2_mean_nn}
\includegraphics[width=.2\textwidth]{qualitative_circles2_aggl}
\includegraphics[width=.2\textwidth]{qualitative_circles2_mst} \\ 

\includegraphics[width=.2\textwidth]{qualitative_twomoons_km}
\includegraphics[width=.2\textwidth]{qualitative_twomoons_mean_nn}
\includegraphics[width=.2\textwidth]{qualitative_twomoons_aggl}
\includegraphics[width=.2\textwidth]{qualitative_twomoons_mst} \\ 
...
faces       &   400 & 4096 &  40 &     0.41\,/\,0.76 & \B{0.49}\,/\,\B{0.80} &0.08\,/\,0.69             &0.02\,/\,0.49\\ %\footnotemark[4]
...
% TODO more experiments: mnist / usps
% TODO intrinsic dimensionality
% todo segmentation unsupervised
% TODO bag of word experiment?

\section{Summary}
In this summary we proposed the use of a minimum spanning tree based,
