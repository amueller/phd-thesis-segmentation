Before going to segmentation, we look at clustering because:
1 we see how far we can go without supervision
2 we need it as building block for bow
3 we need it as initialization for latent variable models
%TODO elaborate
...
%Not only are clusters as found by $k$-Means convex,
%they are given by the Voronoi tessellation of the cluster means.
