...
\begin{itemize}
\item Introducing a general clustering algorithm that improves upon widely used
...
will first investigate general clustering algorithm in Chapter~\ref{ch:itm}.
