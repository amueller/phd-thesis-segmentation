...
optimizing an \emph{prediction engine}, that takes into account all aspects of
...
work. Their work considers the choice of features, number superpixels and
...
We introducing an algorithm for  semi-supervised learning of object class
