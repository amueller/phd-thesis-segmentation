...
or prediction.
While using arbitrary functions is possible, and was explored
...
In the following, we will only discuss this multivariate case. In general, $n$ is often different
