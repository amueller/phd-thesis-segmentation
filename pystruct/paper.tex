...
\toprule
Package       & Cutting Plane& SSGD & BCFW & Latent SSVM & Perceptron & ML\\
...
\end{tabularx}
    \caption{\label{table:comparision_algorithms}Comparison of learning
        ...
        packages. SSGD stochastic subgradient decent learning of SSVMs, BCFW for
    Block-Coordinate Frank-Wolfe, Latent SSVM for latent variable SSVMs, ML for
