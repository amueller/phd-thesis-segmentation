...
Table~\ref{table:comparision_algorithms} lists learning algorithms that are implemented
in \pystruct and compares them to other public structured prediction libraries.
Table~\ref{table:comparision_models} lists 
...
\toprule
Package       & Cutting Plane& SSGD & STLJSP & Latent SSVM & Perceptron & ML\\
\cmidrule(r){1-1} \cmidrule(r){2-7}
\pystruct     & \x        & \x   & \x   & \x          & \x         & \o\\
\svmstruct    & \x        & \o   & \o   & \x          & \o         & \o\\
\sc{Dlib}     & \x        & \x   & \o   & \o          & \x         & \o\\
\sc{CRFsuite} & \o        & \o   & \o   & \o          & \x         & \x\\
...
\end{tabularx}
    \caption{\label{table:comparision_algorithms}Comparison of learning
        ...
        packages. SSGD stochastic subgradient decent learning of SSVMs, STLJSP is
        as described in \secref{dual_coordinate_descent}, Latent SSVM for latent variable SSVMs, ML for
...
\end{tabularx}
    ...
    latend dynamic conditional random fields.}
\end{table}
