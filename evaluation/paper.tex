...
Several trends can be observed: the $n$-slack cutting plane algorithms are
...
subgradient descent.  These results are intiutive, as they reflect ``how much
...
learing learning on this dataset, as loss-augmented predction is as fast as
querying the cache.
