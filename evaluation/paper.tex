...
\begin{figure}
    \begin{tabu} to \linewidth{@{}XX@{}}
    \includegraphics[width=\linewidth]{evaluation/images/letter_big_log}&%
    \includegraphics[width=\linewidth]{evaluation/images/letter_big_log_time}
    \end{tabu}
\caption{%
...
\begin{figure}
    ...
    \end{tabu}
\caption{%
   Convergence of the primal objective on the multi-label datasets. From top to bottom: the scene dataset using a tree model,
   the scene dataset using a full pairwise model, the yeast dataset using a tree model and the yeast dataset using a full pairwise model.
\figlabel{yeast_tree}}
\end{figure}
