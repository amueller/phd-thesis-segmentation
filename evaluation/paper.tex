...
Clearly the $1$-slack algorithms to ``to much'' work, leading to very slow convergence.
Also, caching does not speed up learing learning on this dataset, as loss-augmented predction
is as fast as querying the cache.

We now consider datasets with non-trivial inference.
The results for OCR-small are shown in \figref{ocr_small_iterations} and \figref{ocr_small_time}.
...
\figref{ocr_small_duals} illustrates this point by ploting primal and dual
