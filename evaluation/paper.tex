...
\Figref{ocr_small_dual} illustrates this point by plotting primal and dual
...
algorithms are able to solve the task perfectly. %FIXME more details!
...
of the algorithms terminates prematurely. Also, all algorithms achieve a similar dual value.
All algorithms achieve similar training errors after convergence.
...
down learning here. This is in contrast to the yeast datasets, where the converse was true,
even though both datasets have a similar number of training examples.
Given the outcome described above, we suspect that learning was not affected by approximate
inference too much. We leave a more detailed analysis for Chapter~\ref{ch:exact_learning}.
