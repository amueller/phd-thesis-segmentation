...
% Remove duplication with pystruct intro
...
\section{Learnint Structure Support Vector Machines with Approximate Inference}
%TODO ueberleitung zu approximate inference
% wir machen one-slack und I ist jetzt das und das.
...
We use superpixel-based semantic image segmentation as our application as this is our task of interest. %TODO formulation
