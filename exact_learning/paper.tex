...
competative with comparable approaches on the \textsc{Pascal VOC} dataset.% and nyu?
...
Let $o_{\W}(\theta)$ denote objective \Eqref{oneslack_again} with
...
which is solved using QPBO~\cite{rother2007optimizing}.
...
For the \textsc{Pascal} VOC 2010 dataset, we follow the procedure from \citet{krahenbuhl2012efficient}
