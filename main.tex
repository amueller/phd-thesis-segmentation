...
Mit den vorgestellten Methoden bringen den Stand der Kunst auf
...
from the Literature on a wide array of datasets. Clustering algorithms are an important building block
for higher level computer vision applications, in particular for semantic segmentation.
...
in images. To the best of our knowledge, this is the first algorithm of this
kind, that explicitly addresses complex object classes.
...
The introduced methods provide results advancing the state-of-the art on two complex benchmark datasets
for semantic segmention, the MSRC-21 Dataset of RGB images and the NYU V2 Dataset or RGB-D
images of indoor scenes.

We also introduce a software library that allows us to perform extensive empirical
