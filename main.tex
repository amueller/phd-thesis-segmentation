...
Dissertation\\%[3mm]
zur\\%[3mm]
Erlangung des Doktorgrades (Dr.\ rer.\ nat.)\\%[3mm]
der\\%[3mm]
Mathematisch-Naturwissenschaftlichen Fakult\"at\\%[3mm]
der\\%[3mm]
Rheinischen Friedrich-Wilhelm Universit\"at Bonn\\%[3mm]
vorgelegt von\\%[5mm]
{\LARGE Andreas Christian M\"uller}\\%[5mm]
aus\\%[3mm]
Offenbach am Main\\%[10mm]
Bonn, September 2013
\end{center}
\end{titlepage}
%
...
Current progress in computer vision \dots at an incredible speed,
with new methods and applications emerging constantly.
Still, there are large differences in the paradigms employed by different researchers.
While it is generally aknowledged that context is one of the most important cues
in recognizing objects and interpreting scence, there is little consensus on how
contextual information should be modelled, or even learned.
The structured prediction paradigm allows a principled approach to incoporating
predictions within an image, and to include context information.
We investigated the potential of structural methods for the application of semantic image segmentation
and object recognition, appications to which structured methods have been applied successfully before.
We focus on \emph{learning} of structural models and the interaction of inference and learning
in the neighborhood models typically employed for semantic segmentation.
The thesis presents a software implementation of a variety of popular learning algorithms for structural
support vector machines, together with a thorough evaluation of their properties in the presence
of approximate inference.
We demonstated that exact learning is possible, even in the presence of loops in the
\dots factor graph. We also demonstrate the power of conditioning interactions
on data, learning spacial interactions in a RGB-D setting.

There are several directions for future research that we think would be interesting to pursue as an extention
...
Little empirical comparision was performed, and we are not aware of theoretical
...
%context matters
%structured prediction allows modeling and learning of context and relations
%thesis gives insight into some relations of approximate inference and learning
%gives framework for evaluation
