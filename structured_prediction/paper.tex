...
to a local neighborhood in the image. An example of superpixels computed with the SLIC algorithm can be found in
\Figref{superpixel_illustration}.

The features and superpixel algorithm used for the RGB-D dataset NYU used in Chapter~\ref{ch:nyu} will be discussed there.
