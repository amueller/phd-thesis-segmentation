\documentclass{llncs} % For LaTeX2e \usepackage{amssymb,amsmath,array}
\usepackage[draft]{fixme} \usepackage{booktabs} \usepackage{graphicx}
\usepackage{refstyle} \usepackage[utf8]{inputenc} \usepackage{xspace}
...
school.}  \and Sven Behnke\\ \email{amueller@ais.uni-bonn.de},
\email{behnke@cs.uni-bonn.de}} \institute{Autonomous Intelligent Systems\\
...
\begin{table}
    ...
    \tablabel{graz}
\end{table}
Per-class pixel accuracies are reported in \tabref{graz}; some qualitative results are shown in \figref{results}. The overall
